<template>
  <tab-bar>
    <tab-bar-item path = "/home" active-color="#ff8198">
    ...
    <tab-bar-item path = "/classify" active-color="#ff8198">
    ...
    <tab-bar-item path = "/shopcart" active-color="#ff8198">
    ...
    <tab-bar-item path = "/profile" active-color="#ff8198">
